export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx9b521f6f5f226764",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "9bea079346173d62d012fac3c5a43c2b",
  ...
  USERS: [
    {
      ...
      id: "omrJj6r14Wg4dVDZGGYHWVH8t3KQw",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "AeduaHo88LI4JVzjB4al86p_YFOwkAQVfr290WoRDg8",
      // 所在省份
      province: "陕西",
      // 所在城市
      city: "西安",
      ...
      openUrl: "http://dlb.888dly.vip/38/",
  ...
  CALLBACK_TEMPLATE_ID: "AeduaHo88LI4JVzjB4al86p_YFOwkAQVfr290WoRDg8",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "omrJj6izHXfMA_WVyLajoDTm4_9I",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
